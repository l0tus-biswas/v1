...
function Contact() {
  return (
    <>
      <section className="bg-deepNavyBlue text-white pb-5">
        ...
        <div className="container">
            <div className="row text-center vh-40 ">
                <div className="col-md-7 col-12 my-auto mx-auto " >
                    <div className="mb-4 quote-start-icon-footer">
                        <h1 className="fs-5">What’s Next?</h1>
                        <h1 className="fw-bolder">Get In Touch</h1>
                    </div>
                    <div></div>
                        <p className="lh-base">Although I'm not currently looking for any new opportunities, my inbox is
                        ...
                        <a href="mailto:lotushotmail111@gmail.com"
                            className="btn btn-warning col-md-3 mt-4 p-2 text-white fw-bold"> Say
                            Hello</a>
                    </div>
