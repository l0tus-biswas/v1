                    ...
                    <div className="row ">
                        <div className="col-md-5 col-12 text-center my-auto img">
                            <div className="img-in">
                                <img src="https://avatars.githubusercontent.com/u/102558895?v=4"
                                    className="img-fluid rounded-circle border border-warning border border-4" width="280"
                                    height="280" alt="" />
                                <div className="nav social-icons justify-content-center">
                                    <a href="https://www.linkedin.com/in/lotus-biswas/" target={"_blank"}><i className="fa fa-linkedin" aria-hidden="true"></i></a>
                                    <a href="https://github.com/dev-lotus" target={"_blank"}><i className="fa fa-github" aria-hidden="true"></i></a>
                                    <a href="mailto:lotushotmail111@gmail.com" target={"_blank"}><i className="fa fa-envelope" aria-hidden="true"></i></a>
